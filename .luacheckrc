...
globals = {
    ...
    -- JJ2024
    "EVENT_HERMITCONVERTED",
    "EVENT_HERMITDIED",
    "EVENT_MONKDIED",
    "EVENT_POISONERPOISONED",
    "EVENT_PROSELYTIZED",
    "EVENT_ZEALOTDIED",
    "ROLE_BARRELMIMIC",
    "ROLE_HERMIT",
    ...
    "ROLE_WHEELBOY",
    "ROLE_ZEALOT",
    "MISSIONARY_ANNOUNCE_NONE",
    "MISSIONARY_ANNOUNCE_AS_MISSIONARY",
    "MISSIONARY_ANNOUNCE_AS_MARSHAL",
    "PHARAOH_AURA_COLOR_MODE_DISABLE",
    "PHARAOH_AURA_COLOR_MODE_ROLE",
    "PHARAOH_AURA_COLOR_MODE_TEAM",
    "PHARAOH_AURA_COLOR_MODE_WHITE",
    "WEREWOLF",
    "WEREWOLF_NIGHT_ONLY_SHOW_WEREWOLVES",
    "WEREWOLF_NIGHT_SHOW_IF_HAS_WEREWOLF",
    "WEREWOLF_NIGHT_SHOW_IF_HAD_WEREWOLF",
    "WEREWOLF_NIGHT_ALWAYS_SHOW",
    "WEREWOLF_TIMER_NONE",
    "WEREWOLF_TIMER_WEREWOLVES",
    "WEREWOLF_TIMER_ALL",
    "WEREWOLF_FOG_NONE",
    "WEREWOLF_FOG_NONWEREWOLVES",
    "WEREWOLF_FOG_ALL",
